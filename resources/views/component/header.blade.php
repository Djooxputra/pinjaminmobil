<!-- ========== HEADER ========== -->
<header class="fixed flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
    <nav class="mt-6 relative max-w-[85rem] w-full bg-white border border-gray-200 rounded-[36px] mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto dark:bg-gray-800 dark:border-gray-700"
        ...
        <div class="flex items-center justify-between">
            <a class="flex-none text-xl font-bold text-blue-500 dark:text-white" href="/" aria-label="Brand">PINJAMIN
                MOBIL</a>
            <div class="md:hidden">
                <button type="button"
